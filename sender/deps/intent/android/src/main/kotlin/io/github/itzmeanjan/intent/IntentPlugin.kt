...
class IntentPlugin(private val registrar: Registrar, private val activity: Activity) : MethodCallHandler {
    ...
    override fun onMethodCall(call: MethodCall, result: Result) {
        android.util.Log.d("INTENT-PLUGIN", "onMethodCall: "+call.method)
        android.util.Log.d("INTENT-PLUGIN", "  arguments: "+call.arguments())
        ...
        registrar.addActivityResultListener { requestCode, resultCode, intent ->
            when (requestCode) {
                999 -> {
                    android.util.Log.d("SENDER-INTENT", "requestCode: "+requestCode)
                    android.util.Log.d("SENDER-INTENT", "resultCode: "+resultCode)
                    //android.util.Log.d("SENDER-INTENT", "intent: "+intent)
                    if (resultCode == Activity.RESULT_OK) {
                        val filePaths = mutableListOf<String>()
                        // stop it
                        if (intent == null){
                            android.util.Log.d("SENDER-INTENT", "intent NULL")
                            true
                        }
                        android.util.Log.d("SENDER-INTENT", "intent not null... :) ")

                        if (intent.clipData != null) {
                            android.util.Log.d("SENDER-INTENT", "there are clipData")
                            var i = 0
...
//                    intent.data = Uri.parse("gcw://geocaching/cache?type=u&id=123456")
                ...
                android.util.Log.d("INTENT-PLUGIN", "startActivityForResult: intent.package: "+intent.`package`)
                android.util.Log.d("INTENT-PLUGIN", "startActivityForResult: intent.data: "+intent.data)
                android.util.Log.d("INTENT-PLUGIN", "  arguments: "+call.arguments())
